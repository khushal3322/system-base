<%@ Page Title="" Language="C#" MasterPageFile="~/MovieMaster.master" AutoEventWireup="true" CodeFile="AboutUs.aspx.cs" Inherits="_Default" %>
...
<div class="jumbotron text-center">
  <h1>My Movie Ticket Booking Website</h1> 
  <p></p> 
...
<div class="container-fluid">
  <div class="row">
    <div class="col-sm-8" style="color: #FF3399">
...
<div class="container-fluid text-center" style="color: #FF3399">
  <h2>SERVICES</h2>
  <h4>What we offer</h4>
  <br>
  <div class="row">
  ...
  <div class="row">
    ...
    <div class="col-sm-4">
      ...
      <h4 style="color:#FF3399;">HARD WORK</h4>
      <p>Lorem ipsum dolor sit amet..</p>
    </div>
  </div>
</div>
<footer class="container-fluid text-center">
  ...
  <p style="color: #008000"> Made By <a href="#">KhushalGawas</a></p>
</footer>
