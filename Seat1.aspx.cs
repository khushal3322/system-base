...
public partial class _Default : System.Web.UI.Page
{
    ...
    {
        String mycon = "Data Source=DESKTOP-Q9S348L;Initial Catalog=MovieTicketBooking;Integrated Security=True";
    ...
    protected void Button17_Click(object sender, EventArgs e)
    {
        ...
        for (i = 0; i < 16; i++)
        {
            if (i == 1)
            {
                ...
                massagelable.Text = "i'll KILL YOU !!!";
            }
            if (tempbookseat[i] == 1)
            {
                String mycon = "Data Source=DESKTOP-Q9S348L;Initial Catalog=MovieTicketBooking;Integrated Security=True";
